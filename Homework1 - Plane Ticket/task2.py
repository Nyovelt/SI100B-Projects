...
while (passenger_num):
    ...
    elif (len(ordinary_lane_passenger_list) == 0 and len(priority_lane_passenger_list)):
            output.append(priority_lane_passenger_list[0])
            passenger_num -= 1
            priority_lane_passenger_list.pop(0)
    elif (len(ordinary_lane_passenger_list) and len(priority_lane_passenger_list) == 0):
            output.append(ordinary_lane_passenger_list[0])
            passenger_num -= 1
            ordinary_lane_passenger_list.pop(0)
